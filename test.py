...
with_keys = []
with_keys.append(("P5 key"            , "Lv. 1" ))
with_keys.append(("P0 P9 key"         , "Lv. 2" ))
with_keys.append(("P9 P0 key"         , "Lv. 3" ))
with_keys.append(("P9 P0 P9 key"      , "Lv. 4" ))
with_keys.append(("P3 P4 P7 P2 key"   , "Lv. 4" ))
with_keys.append(("P3 P7 key"         , "Lv. 5" ))
with_keys.append(("P0 P9 P0 key"      , "Lv. 6" ))
with_keys.append(("P9 P5 P8 P3 key"   , "Lv. 7" ))
with_keys.append(("P2 P8 P2 P8 P9 key", "Lv. 8" ))
with_keys.append(("P3 P3 P5 P8 key"   , "Lv. 9" ))
with_keys.append(("P7 P3 P0 P9 P2 key", "Lv. 10"))
with_keys.append(("P6 P5 P3 key"      , "Lv. 12"))
with_keys.append(("P2 P8 P5 P5 key"   , "Lv. 13"))
with_keys.append(("P8 P5 P9 P2 P5 key", "Lv. 14"))
with_keys.append(("S5 P5 key"         , "Lv. 15"))
with_keys.append(("G9 P0 key"         , "Lv. 16"))
with_keys.append(("S2 P7 key"         , "Lv. 17"))
with_keys.append(("G3 P7 key"         , "Lv. 18"))
with_keys.append(("S8 P4 P2 key"      , "Lv. 19"))
with_keys.append(("S4 P2 P9 key"      , "Lv. 20"))

without_keys = []
without_keys.append(("P5"            , "Lv. 1" ))
without_keys.append(("P0 P9"         , "Lv. 2" ))
without_keys.append(("P9 P0"         , "Lv. 3" ))
without_keys.append(("P9 P0 P9"      , "Lv. 4" ))
without_keys.append(("P3 P4 P7 P2"   , "Lv. 4" ))
without_keys.append(("P3 P7"         , "Lv. 5" ))
without_keys.append(("P0 P9 P0"      , "Lv. 6" ))
without_keys.append(("P9 P5 P8 P3"   , "Lv. 7" ))
without_keys.append(("P2 P8 P2 P8 P9", "Lv. 8" ))
without_keys.append(("P3 P3 P5 P8"   , "Lv. 9" ))
without_keys.append(("P7 P3 P0 P9 P2", "Lv. 10"))
without_keys.append(("P6 P5 P3"      , "Lv. 12"))
without_keys.append(("P2 P8 P5 P5"   , "Lv. 13"))
without_keys.append(("P8 P5 P9 P2 P5", "Lv. 14"))
without_keys.append(("S5 P5"         , "Lv. 15"))
without_keys.append(("G9 P0"         , "Lv. 16"))
without_keys.append(("S2 P7"         , "Lv. 17"))
without_keys.append(("G3 P7"         , "Lv. 18"))
without_keys.append(("S8 P4 P2"      , "Lv. 19"))
without_keys.append(("S4 P2 P9"      , "Lv. 20"))

pagesize = "US-letter"
with open("front.svg", "w") as SVG_file:
    SVG_file.write(SVG_locks.SVG_root(kind="front", pagesize=pagesize))
    SVG_file.write(SVG_locks.print_sheet(without_keys, kind="front", pagesize=pagesize, indent=1))
    SVG_file.write(SVG_locks.SVG_root(kind="tail"))

with open("back.svg", "w") as SVG_file:
    SVG_file.write(SVG_locks.SVG_root(kind="front", pagesize=pagesize))
    SVG_file.write(SVG_locks.print_sheet(with_keys, kind="back", pagesize=pagesize, indent=1))
    SVG_file.write(SVG_locks.SVG_root(kind="tail"))
