...
configs = []
configs.append(("P5 key"            , "Lv. 1" ))
configs.append(("P0 P9 key"         , "Lv. 2" ))
configs.append(("P9 P0 key"         , "Lv. 3" ))
configs.append(("P9 P0 P9 key"      , "Lv. 4" ))
configs.append(("P3 P4 P7 P2 key"   , "Lv. 4" ))
configs.append(("P3 P7 key"         , "Lv. 5" ))
configs.append(("P0 P9 P0 key"      , "Lv. 6" ))
configs.append(("P9 P5 P8 P3 key"   , "Lv. 7" ))
configs.append(("P2 P8 P2 P8 P9 key", "Lv. 8" ))
configs.append(("P3 P3 P5 P8 key"   , "Lv. 9" ))
configs.append(("P7 P3 P0 P9 P2 key", "Lv. 10"))
...
configs = []
configs.append(("P5"            , "Lv. 1" ))
configs.append(("P0 P9"         , "Lv. 2" ))
configs.append(("P9 P0"         , "Lv. 3" ))
configs.append(("P9 P0 P9"      , "Lv. 4" ))
configs.append(("P3 P4 P7 P2"   , "Lv. 4" ))
configs.append(("P3 P7"         , "Lv. 5" ))
configs.append(("P0 P9 P0"      , "Lv. 6" ))
configs.append(("P9 P5 P8 P3"   , "Lv. 7" ))
configs.append(("P2 P8 P2 P8 P9", "Lv. 8" ))
configs.append(("P3 P3 P5 P8"   , "Lv. 9" ))
configs.append(("P7 P3 P0 P9 P2", "Lv. 10"))
configs.append(("P6 P5 P3"      , "Lv. 12"))
configs.append(("P2 P8 P5 P5"   , "Lv. 13"))
configs.append(("P8 P5 P9 P2 P5", "Lv. 14"))
configs.append(("S5 P5"         , "Lv. 15"))
configs.append(("G9 P0"         , "Lv. 16"))
configs.append(("S2 P7"         , "Lv. 17"))
configs.append(("G3 P7"         , "Lv. 18"))
configs.append(("S8 P4 P2"      , "Lv. 19"))
configs.append(("S4 P2 P9"      , "Lv. 20"))
